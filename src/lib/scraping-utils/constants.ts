export const FISHING_WORDS = [
  ...
  'surf casting', 'señuelos', 'anzuelos pesca', 'kit pesca',
  'caña spinning', 'caña surf', 'carrete surf',
  'angelrute', 'angelrolle',
]

export const NON_FISHING_WORDS = [
  ...
  'pet ', 'kitchen', 'garden', 'tool', 'tools', 'diy',
  'dog bowl', 'cat bowl', 'dog food', 'cat food',
  'alimentador gato', 'alimentador perro', 'dispensador comida',
  'food dispenser', 'caja herramientas', 'tool box', 'toolbox',
  'cuchillo cocina', 'kitchen knife', 'chef knife', 'makeup',
]
...
export const FISHING_BRANDS = [
  ...
  'hellbender', 'mora', 'kunnan', 'vercelli',
  'beuchat', 'garbolino', 'storm', 'williamson', 'suissex',
  'ragot', 'yo-zuri',
]
